...
|   | Benefits | Limitation |
|:--:|----|----|
| **Sentinel-2** | Its high spatial resolution (10m) and fast revisit time (5 days) are ideal for capturing rapid, fine-scale landscape changes. | It completely lacks the thermal bands necessary for analyzing land surface temperatures and urban heat islands. |
| **Landsat 8** | It provides crucial thermal infrared bands and a decades-long historical archive for long-term environmental and temperature monitoring. | Its lower resolution (30m) and longer revisit cycle (16 days) often miss fine, short-term details in complex urban areas. |
